...
![[Pasted image 20240609112317.png]]
...
> [!important] 
> <mark style="background: #BBFABBA6;">Good to Know</mark>
...
### [Edge Runtime](https://nextjs.org/docs/pages/building-your-application/data-fetching/get-server-side-props#edge-runtime)
`getServerSideProps` can be used with both [Serverless and Edge Runtimes](https://nextjs.org/docs/pages/building-your-application/rendering/edge-and-nodejs-runtimes), and you can set props in both.
...
![[Pasted image 20240609112943.png]]
...
![[Pasted image 20240609113026.png]]
However, before reaching for `cache-control`, we recommend seeing if [`getStaticProps`](https://nextjs.org/docs/pages/building-your-application/data-fetching/get-static-props)with [ISR](https://nextjs.org/docs/pages/building-your-application/data-fetching/incremental-static-regeneration) is a better fit for your use case.
